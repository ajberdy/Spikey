...
//         console.log(dt);
        ...
        var SpikeyOctree = new Octree(new Vec3(-50,-50,-50), new Vec3(1000000000000000,1000000000000000,1000000000000000));

        for (var e = 0; e < this.entities.length; ++e) {
             this.temp=new Vec3(this.entities[e].pos[0],this.entities[e].pos[1],this.entities[e].pos[2])
