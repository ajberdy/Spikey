            ...
            if (this.use_octree) {
             ...
             for (var x = 0; x < this.entities.length; ++x) {
                 ...
                 if (x==0){
                     ...
                     for (var y=1;y<this.entities.length;++y){
                         this.collide(this.entities[0], this.entities[y])
                ...
                this.temp_collision=this.SpikeyOctree.point_search(Vec.of(this.entities[x].pos[0],this.entities[x].pos[1],this.entities[x].pos[2]),200).points
